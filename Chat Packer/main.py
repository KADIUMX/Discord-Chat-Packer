...
chatpack = requests.get('https://pastes.io/raw/umas7g2pjv')
...
file_path = 'chatpack.txt'
with open(file_path, 'r') as file:
    lines = file.readlines()
lines = random.sample(lines, 10)
line1, line2, line3, line4, line5, line6, line7, line8, line9, line10 = lines

import requests
import json
channel_id = input(f'{w}[{g}+{w}] » Channel ID » ')

url1 = 'https://discord.com/api/v9/channels/'+channel_id+'/messages'
data1 = {"content": line1}
header1 = {"authorization": token}
r = requests.post(url1, data=data1, headers=header1)
time.sleep(1)
url1 = 'https://discord.com/api/v9/channels/'+channel_id+'/messages'
data1 = {"content": line2}
header1 = {"authorization": token}
